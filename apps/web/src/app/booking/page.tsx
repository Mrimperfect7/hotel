  ...
  if (done) {
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center">
        ...
        <h1 className="mt-4 font-display text-2xl font-bold text-temple-700">Booking Requested!</h1>
        <p className="mt-2 text-temple-600">
          Your booking request ID is <strong className="text-gold-700">{done.bookingCode}</strong>.
        </p>
        
        <div className="mt-8 p-6 bg-gold-50 border border-gold-200 rounded-2xl">
          <h2 className="font-bold text-temple-900 mb-2">Pending Hotel Approval</h2>
          <p className="text-sm text-temple-600">The hotel owner will review your request shortly. Once they approve it, you will receive an email/SMS with a link to complete your payment.</p>
        </div>
